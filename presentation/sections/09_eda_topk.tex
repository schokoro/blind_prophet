\begin{frame}[plain]
  \begin{tikzpicture}[remember picture,overlay,x=0.1666667mm,y=-0.1666667mm]
    \begin{scope}[shift={(current page.north west)}]
      \slideheader{EDA: отбор релевантных новостей}
  ...
  \begin{columns}[T,totalwidth=\textwidth]
    \begin{column}{0.59\textwidth}
        ...
        \includegraphics[width=\linewidth,height=0.6\textheight,keepaspectratio]{images/unimodal.png}



      \vspace{-4pt}
      {\scriptsize\color{BPMuted}
      «максимальная схожесть с любой из 9 тем — спокойный период vs санкционный шок»}
    \end{column}

    \begin{column}{0.38\textwidth}
      \includegraphics[width=\linewidth,height=0.5\textheight,keepaspectratio]{images/10_retr_vs_nonretr.jpg}
